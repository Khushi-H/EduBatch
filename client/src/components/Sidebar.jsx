  ...
  function renderContent(isCollapsed) {
    return (
      <div className="flex flex-col h-full">
        <div
          className={`flex items-center gap-2 h-16 shrink-0 ${isCollapsed ? "justify-center px-2" : "px-5"}`}
        >
        ...
        <nav
          className={`flex-1 py-4 space-y-1 overflow-y-auto overflow-x-hidden ${isCollapsed ? "px-2" : "px-3"}`}
        >
          {!isCollapsed && (
        ...
        <div className="p-3 border-t border-white/10 shrink-0">
          <div
            className={`flex items-center gap-3 py-2 ${isCollapsed ? "justify-center px-0" : "px-2"}`}
          >
            <div
            ...
            <button
              ...
              title="Logout"
              className={`text-white/50 hover:text-white p-1.5 rounded-lg hover:bg-white/10 shrink-0 ${
                isCollapsed ? "" : "ml-auto"
              }`}
              aria-label="Logout"
            >
